...
Personal **full-stack** config: Bash, Tmux, Git, Alacritty, Neovim, clangd, and clang-format.
...
|--------|---------|----------|
| **`home-pc`** | Home Fedora PC | **All** of: `bash/`, `tmux/`, `git/`, `alacritty/`, `nvim/`, `.clangd`, `.clang-format`, `install.sh`, `uninstall.sh` |
...
./uninstall.sh  # unlinks repo-managed symlinks
```
